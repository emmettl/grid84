...
| **Protect and Survive: Britain** | The Home Office's Square Leg (1980) and Hard Rock (1982) exercises; Openshaw, Steadman and Greene, *Doomsday: Britain after Nuclear Attack* (1983); Campbell, *War Plan UK* (1982); the JIC's declassified assessment of probable Soviet targets; the Warsaw Pact's Seven Days to the River Rhine (1979, released 2005) | British scholarship drew the fallout plumes over real counties forty years ago; the fallout lab was built for that geometry. Both sides' plans are partly in the record, so the withheld tier and the documented tier sit next to each other on one small island. Brief to follow. |
