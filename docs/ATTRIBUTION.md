...
Every service and dataset the published site touches, what its terms ask, where the site meets them, and what was changed on 9 September 2026 to close the gaps found. The site is non-commercial and is published at `https://grid84.app/` and `https://emmettl.github.io/grid84/`.
...
| Glasstone and Dolan, *The Effects of Nuclear Weapons*, 3rd edition 1977, and Glasstone (ed.), revised edition 1962 | Prepared by the United States Department of Defense and published by the Energy Research and Development Administration (1977) and the Atomic Energy Commission (1962): United States government works, public domain | Cited by chapter, paragraph and table in the model files, the briefs and `docs/VALIDATION.md` | Met. Figures and tables are used as data and cited by number; no text is reproduced. The blast, thermal, prompt-radiation and fallout models all rest on the 1977 edition; the 1962 edition is quoted where it tabulates something the 1977 edition draws as a graph |
...
| The published polynomial fit to Glasstone & Dolan Figure 2.16 (cloud height and radius against yield), from the Wikimedia Commons reproduction of that figure | The fit is a short mathematical expression, not a creative work; the data it fits is the public-domain figure itself | `src/models/cloud.ts` and the cloud lab | Met. The fit is named as a fit and not as Glasstone on every readout that uses it, and the source figure is cited by number |
