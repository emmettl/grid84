...
**1d. The V-force.** Proposed 10 September 2026 and briefed in [V-FORCE.md](docs/V-FORCE.md): the RAF's V-bomber plan as the case where the flight profile is the whole story, high level until 1960 and the deck afterwards. The engine now has the profiles; what it needs is an order of battle from Wynn's official history and the discipline to leave the target list withheld, because it has never been released. Not built.
