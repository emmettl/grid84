...
**1e. The theatre.** Proposed 10 September 2026 and briefed in [THEATRE.md](docs/THEATRE.md): the tactical and theatre doctrine of Europe from Carte Blanche in 1955 to the Euromissiles, on the argument that strategic policy cannot be read apart from theatre escalation, since flexible response only deterred if theatre use led somewhere. Four scenarios proposed, the first being Seven Days to the River Rhine, the Warsaw Pact plan of 1979 that Poland declassified in 2005 and the rarest thing in the field: a theatre nuclear plan with a target list on the record. Not built.
