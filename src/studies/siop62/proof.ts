...
export const SIOP62_PROOF: Study = {
  ...
  // Four days after the impact, not after H-hour, so the plume's dose window closes before the clock does.
  surfaceBounds: { start: -4 * 3_600, end: Math.ceil(IMPACT / 3_600 + 96) * 3_600 },
  ...
  omissions: [
    ...
    'Fallout: only in surface-burst mode, under an assumed wind; the air-burst mode has none',
  ...
  entities: [
    ...
    },
    {
      ...
      designation: 'W49 1.44 MT · YIELD DOCUMENTED, BURST ASSUMED',
      center: ANADYR,
      time: IMPACT,
      effects,
      burst: 'air',
      fallout: {
        ...
        untilHours: 96,
        provenance: { source: 'Assumed', method: 'W49 fission fraction not published, 50 percent assumed; a 15 mph wind towards 090° is a choice, not a climatology' },
      },
      evidence: 'modelled',
